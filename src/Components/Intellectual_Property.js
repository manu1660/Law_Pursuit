...
import images from './images/intellectual_property_laws.jpg'
            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        ...
                        At Law Pursuit, we understand that Intellectual property is a vital tool in the survival and continuity of a business. 
                        We advices on all aspects of creation, exploitation and enforcement of IP rights, including contentious and non contentious 
                        matters relating to Patents, Trademarks, Copyright (including broadcast rights), Geographical Indications, Information technology, 
                        Confidential information, Brands & Domain names, Designs & Trade secrets, Sponsorship rights etc.
                        </Typography>
                        <br />
                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}}>
                            Our IPR Practice Covers :
                        <ul>
                            <li><RxDotFilled />Registration and prosecution of Trademarks, Designs, Copyright, Geographical Indications</li>
                            <li><RxDotFilled />Managing Trademark portfolios</li>
                            <li><RxDotFilled />Intellectual Property due diligence and brand audits</li>
                            <li><RxDotFilled />Licensing and assignment of Intellectual Property</li>
                            <li><RxDotFilled />Assistance in negotiating transaction documents</li>
                            <li><RxDotFilled />IP litigation</li>
                        </ul>
                        </Typography>
                    </Paper>  
                </Grid>
