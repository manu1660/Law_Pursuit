...
import images from './images/pharma.jpg'
            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        ...
                        The Pharmaceuticals and Healthcare sector encompasses range of challenges that a company operating in the sector faces: 
                        from scientific advancement, volatile government regulations to strict adherence of ethical norms, we make sure our legal 
                        advice is based on deep - knowledge & comprehensive experience in Pharmaceutical and Healthcare sector.
                        </Typography>
                        <br />
                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}}>
                        Areas of law we advise our pharmaceutical and healthcare clients includes intellectual property, regulation, competition,
                         corporate law, antitrust, commercial litigation and M&A issues across India and abroad.
                        </Typography>
                        <br />
                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}}>
                        We advise & represent companies working in:
                         <ul>
                            <li><RxDotFilled />Pharmaceuticals</li>
                            <li><RxDotFilled />Biotechnology</li>
                            <li><RxDotFilled />Research and development</li>
                            <li><RxDotFilled />Medical devices</li>
                            <li><RxDotFilled />Health insurance</li>
                            <li><RxDotFilled />Health services provision</li>
                            <li><RxDotFilled />Hospitals and medical facilities and</li>
                            <li><RxDotFilled />Private equity firms, investors and financial advisers to the sector</li>
