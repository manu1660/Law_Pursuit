    ...
    return (
        <Grid container>
            ...
            <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5,height:'500px' }}>
                        <Typography   gutterBottom >
                            <div class="image">
                        <img src="https://i.ibb.co/x1DYQt3/lawyer.jpg"></img> 
                        <div style={{color:'#737373',fontWeight:500,fontSize:'25px',lineHeight:1.5,fontFamily:'inherit'}}>JAY SANKAR MENON</div>
                        <h4>PARTNER</h4>
                        <div class="w500" style={{color:'#737373',fontWeight:700}}>Key Focus Areas :</div>
                        <ul>
                            <li><RxDotFilled />Human Resources & Labour Law</li>
                            <li><RxDotFilled />Industrial Relations</li>
                            <li><RxDotFilled />Anti-harassment policies</li>
                            
                        </ul>
                        
                        <div class="w501" style={{color:'#737373',fontWeight:700}}>Professional Memberships</div>
                        <ul>
                            <li><RxDotFilled />Bar Council of India </li>
                        </ul>
                        
                        <div class="social">
                        <button type="button" style={{marginLeft:'60px'}}  class="btn btn-primary"><LinkedIn style={{marginTop:'-5px'}} />LinkedIn</button>
                        
                        </div>
                        </div>
                        </Typography>
                        
                        <Typography variant='h6' sx={{ fontSize: '15px',fontWeight:300, marginLeft:'350px', marginTop:'-450px'}} >
                        With over 23 years of professional experience, Jay's expertise extends beyond conventional employee-employer <br /> relations and encompasses a wide range of areas such as labour law 
                        compliance, litigation support, and the <br/> drafting of employment-related documents. He has  provided invaluable guidance to clients in investigations and <br /> disciplinary proceedings, 
                        making significant contributions to their resolution. Having spearheaded numerous Human <br /> Resources initiatives, Jay has played a pivotal role in shaping the fundamental framework of 
                        organizations. His <br /> extensive knowledge of labour laws has been instrumental in effectively addressing various challenges <br /> encountered by personnel departments.
                        </Typography>
                        <h3 style={{marginLeft:'350px',marginTop:'20px'}}>Areas of Specialization</h3>
                        <p style={{marginLeft:'350px',marginTop:'20px'}}>Jay provides comprehensive assistance to clients across diverse Human Resources and labour law issues, <br /> 
                            spanning the entire spectrum from Recruitment to Separation. His primary focus revolves around crucial <br /> Industrial Relations matters, including trade unionism, grievance redressal mechanisms, disciplinary procedures, <br /> 
                            anti-harassment policies, and termination laws.</p>
                            <h3 style={{marginLeft:'350px',marginTop:'20px'}}>Education</h3>
                            <p style={{marginLeft:'350px',marginTop:'20px'}}>BA Economics, LLB, MBA (HR)</p>
                    </Paper>  
                </Grid>
