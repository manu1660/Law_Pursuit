...
import images from './images/work_with_us.jpg'
...
const WorkwithUs = () => {
    ...
    return (
        <Grid container>
            <Grid item sx={{ backgroundImage: `url(${images})`, backgroundRepeat:"no-repeat",height:'500px' }}>
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Work with Us</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)'}}>
                        ...
                        We at Law Pursuit believe in teamwork and offer a dynamic environment that is challenging as well as rewarding. Our work culture is inclusive, ethical and value-based encouraging client innovation. We welcome talented lawyers to be part of the Firm, learning on the job, sharing their perspective on key issues and matters. : info@lawpursuit.in
                        </Typography>
                    </Paper>
                </Grid>
