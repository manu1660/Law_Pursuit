            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        ...
                        Law Pursuit assist our clients on taxation matters both on domestic transactions and overseas jurisdictional transactions.
                         We regularly Representation in appeal proceedings before Income Tax Appellate Tribunals (ITAT), Customs, Excise and Service 
                         Tax Appellate Tribunal (CESTAT), High Courts and Supreme Court. Our tax team has deep knowledge and expertise in varied areas of tax segment including:
                         <ul>
                            <li><RxDotFilled />Income Tax</li>
                            <li><RxDotFilled />Service Tax</li>
                            <li><RxDotFilled />Customs & Excise Duty</li>
                            <li><RxDotFilled />Anti - Dumping Duty</li>
                            <li><RxDotFilled />Safeguard Duty & Countervailing Duty</li>
                            <li><RxDotFilled />Foreign Trade Policy and FEMA</li>
                            <li><RxDotFilled />Export Incentive Schemes and other Border Trade Regulations dealing with day to day imports and exports cases</li>
