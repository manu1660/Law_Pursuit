...
import images from './images/media_entertainment_laws.jpg'
import { RxDotFilled } from "react-icons/rx"
import { useState } from "react";
const EntertainmentLawMedia = () => {
            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)', }}>
                        ...
                        Entertainemnt Law Media
                        </Typography>

                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}} >
                        At Law Pursuit we understand the unique challenges & complexities of a multi - billion dollar Entertainment & Media Industry. We have deep 
                        knowledge and expertise in the commercial and legal issues surrounding the media and entertainment industry and provide practical advice to our clients across multitude of entertainment industry platforms including:

                        <ul>
                            <li><RxDotFilled />Television & motion pictures;</li>
                            <li><RxDotFilled />Talent & Celebrity managements;</li>
                            <li><RxDotFilled />Brand endorsements</li>
                            <li><RxDotFilled />Music, Internet & Digital media</li>
                            <li><RxDotFilled />Publishing & Advertisement;</li>
                            <li><RxDotFilled />Sponsorship deals;</li>
                            <li><RxDotFilled />Intellectual Property rights</li>
                            <li><RxDotFilled />Sports; Public relations amongst others</li>
...
export default EntertainmentLawMedia