            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        ...
                        In our law firm, we offer dedicated family court services to clients seeking legal assistance in matters related to 
                        family law in India. Our experienced team of family law attorneys understands the sensitive and complex nature of family
                         disputes and provides compassionate and effective representation. Here's an overview of our family court services in India:
                         
                         <ul>
                            <li><RxDotFilled />Divorce and Separation: We assist clients in navigating the legal process of divorce and separation, including contested and mutual consent divorces. Our lawyers provide guidance on grounds for divorce, property division, alimony, child custody, and visitation rights, ensuring our clients' rights and interests are protected.</li>
                            <li><RxDotFilled />Child Custody and Guardianship: We represent clients in child custody matters, including determining custody arrangements, visitation schedules, and parental rights and responsibilities. Our attorneys strive to protect the best interests of the child while advocating for our clients' rights as parents.</li>
                            <li><RxDotFilled />Maintenance and Alimony: Our firm assists clients in seeking or defending claims for spousal maintenance and alimony. We analyze the relevant factors, such as the financial capabilities and needs of both parties, to determine fair and reasonable support arrangements.</li>
                            <li><RxDotFilled />Adoption: We guide clients through the legal process of adoption, ensuring compliance with applicable adoption laws and regulations. Our lawyers assist in preparing adoption petitions, conducting background checks, and representing clients in adoption proceedings.</li>
                            <li><RxDotFilled />Domestic Violence: Our team provides legal assistance to victims of domestic violence, helping them obtain protection orders, restraining orders, and other necessary legal remedies. We offer support and representation throughout the legal process, ensuring the safety and well-being of our clients.</li>
                            <li><RxDotFilled />Property and Asset Division: We assist clients in dividing marital assets and properties during divorce proceedings. Our attorneys analyze and assess the value of assets, negotiate settlements, and, if necessary, litigate property disputes to protect our clients' financial interests.</li>
                            <li><RxDotFilled />Mediation and Settlement: We recognize the benefits of alternative dispute resolution methods in family law cases. Our firm offers mediation services to help parties reach amicable resolutions outside of court, promoting effective communication and reducing conflict.</li>
                            <li><RxDotFilled />Paternity and DNA Testing: We provide legal guidance and representation in establishing paternity, including DNA testing, and its legal implications for child support, custody, and visitation matters.</li>
                            <li><RxDotFilled />Legal Documentation and Representation: Our firm assists clients in drafting and reviewing legal documents related to family law, including prenuptial agreements, postnuptial agreements, and settlement agreements. We also provide representation in family court hearings and proceedings.</li>
                            <li><RxDotFilled />Counseling and Support: We understand the emotional challenges that accompany family law matters. Our firm provides counseling support and referrals to professional counselors or therapists to help clients navigate the emotional aspects of their cases.</li>
...
export default FamiltCourtServices;