...
import images from './images/img_11.jpg'
...
const RealEstateConstruction = () => {
    ...
    return(
        <Grid container>
            <Grid item xs={12} sx={{ backgroundImage: `url(${images})`, backgroundRepeat:"no-repeat",height:'315px'}}>
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        ...
                        The strength of our real estate and construction services lies in our in-depth knowledge and understanding of the traditional as well 
                        as modern legal & regulatory environment of the real estate & construction industry. We represent both Indian as well as international 
                        developers, property owners, government entities, corporate houses, hotel operators, educational institutions, offshore and domestic funds 
                        / lenders, investors, contractors, financial institutions, landlords and tenants.
                        </Typography >
                        <br />
                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}}>
                        We advise our clients on all aspects of property law including:
                        <ul>
                        <li><RxDotFilled />Real estate acquisition</li>
                            <li><RxDotFilled />SEZs & townships</li>
                            <li><RxDotFilled />Hospitality</li>
                            <li><RxDotFilled />Affordable housing</li>
                            <li><RxDotFilled />Healthcare</li>
                            <li><RxDotFilled />Education</li>
                            <li><RxDotFilled />Information technology & industrial parks, etc</li>
                            <li><RxDotFilled />Investments / financing in the real estate sector, REITs etc.</li> 
                        </ul>
                        </Typography>
                        <br />
                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}}>
                        Some of the services that LAW PURSUIT regularly provides for our Real estate and Construction industry clients include:
                        <ul>
                            <li><RxDotFilled />Drafting, reviewing and negotiating construction & infrastructure contracts</li>
                            <li><RxDotFilled />Due Diligence</li>
                            <li><RxDotFilled />Identifying suitable project delivery process</li>
                            <li><RxDotFilled />Preparing bid packages and proposals</li>
                            <li><RxDotFilled />Drafting, reviewing and negotiating development, completion and takeover agreements</li>
                            <li><RxDotFilled />Claims preparation and analysis and</li>
                            <li><RxDotFilled />Representing clients before administrative & regulatory agencies in India</li> 
                        </ul>
                        </Typography>
                    </Paper>  
                </Grid>
