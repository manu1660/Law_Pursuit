...
import images from './images/img_about.jpg'
...
const FirmProfile = () => {
    ...
    return (
        ...
        <Grid container>
            <Grid style={{ backgroundImage:`url(${images})`,backgroundRepeat:"no-repeat",height:'700px'}}>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5,boxShadow:'0px 0px 15px rgba(0,0,0,0.5)'}}>
                        <Typography variant='h6' sx={{ fontSize: 25, fontWeight:'bold',color:'#cf2129' }} gutterBottom >
                        FIRM PROFILE
                        </Typography>
                        <Typography variant='h6' sx={{ fontSize:15}} >
                        Law Pursuit is one of the fastest growing, multi-disciplinary law firms in India, established with a mission to provide legal services that compliment our creative, qualitative as well as pragmatic approach. <br />
                        Headquartered in Kochi, we service clients in most of the major commercial hubs, including Mumbai, New Delhi, Bangalore, Chennai and Kolkata and have a strong presence in the Middle East region through our office in Dubai. We believe in active partnerships and have built global relationship in all corners of the world particularly in the US, UK, Australia, North Africa and Asia Pacific region.
                        Our knowledge and expertise across Corporate, Civil, Regulatory and Litigation areas uniquely positions us to advise clients on multi-faceted matters and provide integrated legal services to both domestic as well as international clients, including Government and Public authorities, Commercial banks, Financial institutions, Fortune 500 companies, Equity and Venture capital funds, Pharmaceutical, Infrastructure, Telecom, Media, IT, Insurance, Mutual Fund, Banking sectors etc.
                        </Typography>
                    </Paper>
                </Grid>
