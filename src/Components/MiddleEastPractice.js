...
import images from './images/our_edge.jpg'
import { useState } from "react";

const MiddleEastPractice = () => {
    ...
    return (
        <Grid container>
            <Grid item xs={12} sx={{ backgroundImage: `url(${images}) `, backgroundRepeat:"no-repeat",height:'700px'}}>
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Middle East Practice</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px"}}>
                    <Paper sx={{ p: 5, boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        ...
                        Through our strong presence in Dubai, UAE, we cater to the Middle East regions. Our office in Dubai serves as an entry - point to the Gulf region and we serve our clients on wide range of matters, including on Corporate and Commercial Law, Intellectual Property matters, Entertainment and Media Law, Labour law, Documentation, Projects & Infrastructure cases etc.<br />
                        We have in - depth knowledge of the region's distinct legal, regulatory, and business structures. We also maintain collaborative relationships with local counsel throughout the Middle East. <br />
                        Whether assisting Indian companies doing business in the Gulf region or supporting local businesses in their efforts to expand in India, we understand the challenges of doing business in vastly different legal context and help our clients navigate through & tackle their most complex commercial and legal challenges in unfamiliar territories.
                        </Typography>
                    </Paper>  
                </Grid>
...
export default MiddleEastPractice