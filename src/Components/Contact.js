...
import { Grid, colors,Paper,Typography,Box,Avatar } from "@mui/material";
import images from './images/contact_us.jpg'
...
const Contact = () => {
    ...
    return (
        <Grid container>
            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Contact Us</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    <Paper sx={{ p: 5,boxShadow:'0px 0px 15px rgba(0,0,0,0.5)' }}>
                        <Typography variant='h5' sx={{ fontSize: 25,color:'#cf2129' }} gutterBottom >
                        Law Pursuit
                        </Typography>

                        <Typography variant='h6' sx={{ fontSize: 15, LineHeight:5}} >
                           <div class="contact">
                            <table>
                                <tr>
                                   <td><h6 >Address <span style={{marginLeft:'5px'}}>:</span><b style={{marginLeft:"5px"}}> KOCHI</b></h6> </td> 
                                   
                                </tr>
                                
                                <h6 style={{marginLeft:"85px"}}>Door.No:68/1402,Papali Chambers,</h6>
                                <h6 style={{marginLeft:"85px"}}>Tatapuram Sukumaram Road, Kacheripady,</h6>
                                <h6 style={{marginLeft:"85px"}}>Kochi - 682026</h6>
                                <tr>
                                    <td><h6>Tel No <span style={{marginLeft:'20px'}}>:</span>+91 8848234656</h6></td>
                                </tr>
                            </table>
                           </div>
                        </Typography>
