...
import images from './images/employment.jpg'
import { RxDotFilled } from "react-icons/rx"
import { useState } from "react";
const EmploymentLabourLaws = () => {
            ...
            <h1 style={{color:'white', fontSize:'45px',fontWeight:700,position:'absolute',left:'100px',top:'180px'}}>Practice Focus</h1>
                <Grid item xs={12} sx={{ alignItems:'center', mt: 27, p: "100px" }}>
                    ...
                    <Typography variant='h5' sx={{ fontSize: 25, fontWeight:"bold",color:'#cf2129' }} gutterBottom >
                        ...
                        Magus Legal's Employment and Labour Law services encompass all aspects of employment and Labour-related matters & disputes 
                        that may arise as a result of activities of workers and employees in various capacities. Our capabilities covers relevant Indian 
                        labour laws, regulatory requirements, drafting and reviewing employment contracts including specialization in collective bargaining 
                        negotiations, government relations, including the process of legislative and regulatory change.
                        </Typography>
                        <br />
                        <Typography variant='h6' sx={{ fontSize: 15,lineHeight:2}} >
                        Our Employment and Labour Law Services Include:
                         <ul>
                            <li><RxDotFilled />Advising clients on Employment laws, labour laws, and Industrial regulations in India and abroad</li>
                            <li><RxDotFilled />Assisting and representing clients in Employment disputes, Disciplinary proceedings and trade disputes</li>
                            <li><RxDotFilled />Assisting organizations in complying with employment laws and labour laws and</li>
                            <li><RxDotFilled />Providing other legal services related to labour and employment</li>
...
export default EmploymentLabourLaws